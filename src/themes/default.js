const theme = {
  button: {
    ...
    outline: {
      ...
      primary:
        'border border-purple-600 text-purple-600 hover:bg-purple-800 hover:text-white',
      success:
        'border border-green-500 text-green-600 hover:bg-green-800 hover:text-white',
      danger:
        'border border-red-500 text-red-600 hover:bg-red-800 hover:text-white',
      neutral:
        'border border-gray-500 text-gray-800 hover:bg-gray-800 hover:text-white',
    },
  },
  pill: {
  ...
  dropdown: {
    ...
    list: {
      base: 'absolute w-64 p-2 mt-2 text-gray-700 font-medium text-base bg-white border border-gray-100 rounded-lg shadow-md min-w-max-content dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700',
    },
    item: {
      base: 'flex w-full justify-between cursor-pointer rounded-md hover:text-black hover:bg-gray-100 px-3 py-1',
    },
  },
  input: {
    base: 'block w-full px-2 py-1 font-thin transition duration-200 focus:shadow-lg focus:outline-none ring-offset-2',
  ...
  list: {
    base: 'w-full p-6 flex flex-col justify-center items-center space-y-4 list-none',
    header:
      'w-full px-6 py-3 bg-gray-100 flex items-center justify-center rounded-md shadow-md',
    item: {
      base: 'w-full p-6 bg-white rounded-xl shadow-sm border border-gray-50 transition duration-200 hover:bg-blue-100',
    },
  },
  alert: {
  ...
  transition: {
    fade: {
      appear: 'opacity-0',
      appearActive:
        'opacity-100 transition-opacity duration-500 ease-in-out opacity-100',
    ...
    grow: {
      ...
      appearActive:
        'transform scale-100 transition-transform duration-500 ease-in-out',
